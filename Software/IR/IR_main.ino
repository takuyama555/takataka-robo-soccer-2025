...
void loop(void) {
    ...
    // ボールの角度をシリアルモニタに表示
    Serial.print("Ball Angle (Radians): ");
    Serial.print(ir.ir_angle_LPF);  // ボールの角度 (ラジアン)
    Serial.print(" | Ball Angle (Degrees): ");
    Serial.println(ir.ir_angle_LPF * 180.0 / PI);  // ボールの角度 (度)
